...
/**
 * Plugin BatchEdit: French language file
 *
...
$lang['err_emptyidx']          = 'L\'index de page est vide.';
$lang['err_idxaccess']         = 'Ne peut accéder à l\'index de page.';
$lang['err_emptyns']           = 'Les pages trouvées dans la catégorie "{1}"';
...
$lang['war_matchfail']         = 'Échec dans le remplacement de l’occurrence {1}.';
$lang['war_searchlimit']       = 'La recherche s\'est interrompue après avoir atteint le nombre maximal de correspondances.';
...
$lang['lbl_summary']           = 'Résumé des changements';
$lang['lbl_minor']             = 'Modifications mineures';
$lang['lbl_searchmode']        = 'Mode de recherche';
$lang['lbl_searchtext']        = 'Plein texte';
$lang['lbl_searchregexp']      = 'Expression régulière';
$lang['lbl_matchcase']         = 'Sensible à la casse';
$lang['lbl_multiline']         = 'Multi-ligne';
...
$lang['lbl_keepmarks']         = 'Preserver la sélection lors de la prévisualisation de {1}';
...
$lang['sts_matches#one']       = '{1} occurrence';
$lang['sts_matches#many']      = '{1} occurrences';
